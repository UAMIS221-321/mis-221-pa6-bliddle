...
function handleNewClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-large btn-cancle\" onclick=\"handleCancelSave()\">Cancel<\button>"
    document.getElementById("saveButton").innerHTML = buttomHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
...
function hideButtons(){
    document.getElementById("newButtom").style.display = "none";
...
function showButtons(){
    document.getElementById("newButtom").style.display = "inline-block";
